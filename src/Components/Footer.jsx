...
function Footer() {
  return (
    <div data-scroll data-scroll-section  data-scroll-speed="-.1" className='bg-[#F1F1F1] rounded-t-xl  min-h-screen w-full px-14'>
        <div data-scroll  data-scroll-speed=".2" className='flex justify-between'>
            <div className='w-[48%] pt-[8vw]  text-[#212121] font-["Founders_Grotesk_X"] font-semibold text-[10vw] uppercase leading-[7vw]'>
                <h1>Eye-</h1>
                <h1>Opening</h1>
            </div>
            <div className='flex flex-col  '>
                <div className='w-[40%]  pt-[7vw] text-[#212121] font-["Founders_Grotesk_X"] font-semibold text-[9vw] leading-none uppercase '>
                    <h1>Presentations</h1>
                </div>
                <div className='flex flex-col font-["Neue_Montreal"]'>
                    <h3 className='text-[1.1vw]'>S:</h3>
                    <div className='flex flex-col underline mt-[1vw]'>
                        {["Instagram","Behance","Facebook","Linkedin"].map((item,index)=>{
                            return(
                                <div key={index} className='text-[1.1vw]'>
                                    {item}
                                </div>
                            )
                        })}
                ...
                <div className='flex font-["Neue_Montreal"] justify-between'>
                    <div className='flex flex-col mt-[2vw]'>
                        <h3>L:</h3>
                        <div className='mt-[1vw] mb-[1.5vw] underline text-[1.1vw]'>
                            <h4>202-1965 W 4th Ave</h4>
                            <h4>Vancouver,Canada</h4>
                        </div>
                        <div className='mb-[1vw] underline text-[1.1vw]'>
                            <h4>20 Chukarina St</h4>
                            <h4>Lviv,Ukraine</h4>
                        </div>
                    </div>
                    <div className='flex flex-col mt-[1vw]'>
                        <h3 className='mb-[1.4vw]'>M:</h3>
                ...
                <div className='flex flex-col font-["Neue_Montreal"] mt-[1vw]'>

                    <h3 className='mb-[1vw] text-[1.1vw]'>E:</h3>
                    <h3 className='text-[1.1vw] underline'>hello@ochi.design</h3>
                </div>
            </div>
        </div>

        <div data-scroll className='flex justify-between font-["Neue_Montreal"] mt-[3vw] items-center'>
            ...
            <h3 className='text-[#B2B2B2] mb-[2vw] pl-[20vw] text-[1.1vw]'>&copy; ochi design 2024.<span className='underline'>Legal Terms</span></h3>

            <h3 className='text-[#B2B2B2] mb-[2vw] text-[1.1vw]'>Website by Obys</h3>
