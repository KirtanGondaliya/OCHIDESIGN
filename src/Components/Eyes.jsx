...
function Eyes() {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center overflow-hidden">
      <div data-scroll data-scroll-speed="-.8" className='w-full h-full bg-[url("E:\FrontEndDomination\Projects\OchiDesign\src\Components\background.jpg")] bg-cover relative bg-center'>
