...
function LandingPage() {
  return (
    <div data-scroll className="w-full mb-[3.3vw] ">
      <div data-scroll data-scroll-speed="-.4" className="mt-28 px-14">
        {["We Create", "Eye-Opening", "Presentations"].map((item, index) => {
          return (
            <div className="mask">
              <div
                className="textStructure w-fit flex items-center gap-4 tracking-tighter"
                key={index}
              >
                {index === 1 && (
                  <motion.div
      ...
      <div data-scroll data-scroll-speed="-.4"  className="border-t-[1px] border-[#6F6F6F] mt-20 flex items-center py-4 px-14 justify-between ">
        {[
          "For public and private companies",
          "From the first pitch to IPO",
        ].map((item, index) => {
          return <p className="text-[1.1vw]  leading-none">{item}</p>;
        })}
        <div className="start flex items-center gap-1">
          <div className=" ease-in transition-all duration-100 px-4 py-1 border-[#6F6F6F] border-[2px] rounded-full uppercase">
            start the project
          </div>
          <div className="  ease-in transition-all duration-100 rounded-full border-[1px] border-[#6F6F6F]  rotate-[45deg] px-2 py-2 ">
            <FaArrowUp />
          </div>
        </div>
      </div>
